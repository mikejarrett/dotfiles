...
"                       (_)_/ |_|_| |_| |_|_|  \___|
"
" Author: Mike Jarrett <mike.d.jarrett@joedicastro.com>
...
call dein#add('mikejarrett/vim-markdown-extra-preview')
...
if has('python3')
    map <LocalLeader>mp :Me3<CR>
    map <LocalLeader>mr :Mer3<CR>
else
